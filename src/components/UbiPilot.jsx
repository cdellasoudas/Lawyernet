    ...
    <section id="ubi-pilot" className="container" style={{ padding: isOpen ? '6rem 2rem' : '2rem 2rem', transition: 'padding 0.3s ease' }}>
      ...
      <div className="animate-fade-in" style={{ maxWidth: '900px', margin: '0 auto' }}>
        ...
        <div style={{ textAlign: 'center', marginBottom: '4rem' }}>
          <h3 style={{ fontSize: '2rem', color: '#ffffff', marginBottom: '1rem', fontWeight: 300, letterSpacing: '2px', textTransform: 'uppercase' }}>EDBIC: The Extreme Distribution Basic Income Coin</h3>
          <h4 style={{ fontSize: '1.4rem', color: '#cbd5e1', fontWeight: 300, letterSpacing: '1px' }}>The Public Blueprint & Roadmap</h4>
        </div>
        ...
        <div style={{ background: 'rgba(255,255,255,0.02)', padding: '3rem', borderRadius: '16px', marginBottom: '3rem', border: '1px solid rgba(255,255,255,0.1)', backdropFilter: 'blur(10px)' }}>
          ...
          <p style={{ fontSize: '1.25rem', lineHeight: '1.8', color: '#cbd5e1', marginBottom: '1.5rem', fontWeight: 300 }}>
          ...
          <p style={{ fontSize: '1.25rem', lineHeight: '1.8', color: '#cbd5e1', fontWeight: 300 }}>
        ...
        <div style={{ background: 'rgba(255,255,255,0.02)', padding: '3rem', borderRadius: '16px', marginBottom: '3rem', border: '1px solid rgba(255,255,255,0.1)', backdropFilter: 'blur(10px)' }}>
          ...
          <p style={{ fontSize: '1.25rem', lineHeight: '1.8', color: '#cbd5e1', marginBottom: '2.5rem', fontWeight: 300 }}>
            At the core of EDBIC are three unchangeable, mathematically guaranteed economic principles:
          </p>

          <div style={{ marginBottom: '2.5rem' }}>
            <h4 style={{ fontSize: '1.4rem', color: '#ffffff', marginBottom: '1rem', fontWeight: 400, letterSpacing: '1px', textTransform: 'uppercase' }}>A. The Universal Basic Income (UBI) Mint</h4>
            <p style={{ fontSize: '1.25rem', lineHeight: '1.8', color: '#cbd5e1', marginBottom: '1rem', fontWeight: 300 }}>Every verified human being on the EDBIC network receives a guaranteed daily deposit of newly minted EDBIC tokens.</p>
          ...
          <div style={{ marginBottom: '2.5rem' }}>
            <h4 style={{ fontSize: '1.4rem', color: '#ffffff', marginBottom: '1rem', fontWeight: 400, letterSpacing: '1px', textTransform: 'uppercase' }}>B. The Demurrage Tax (The Melting Coin)</h4>
            <p style={{ fontSize: '1.25rem', lineHeight: '1.8', color: '#cbd5e1', marginBottom: '1rem', fontWeight: 300 }}>In legacy finance, holding money earns interest—which mathematically drains the working class to pay the wealthy. EDBIC reverses this.</p>
            <ul style={{ listStyle: 'none', paddingLeft: '0' }}>
              <li style={{ position: 'relative', paddingLeft: '1.5rem', marginBottom: '0.8rem', color: '#cbd5e1', lineHeight: '1.6', fontWeight: 300 }}>
                <span style={{ position: 'absolute', left: '0', color: '#ffffff' }}>•</span>
          ...
          <div>
            <h4 style={{ fontSize: '1.4rem', color: '#ffffff', marginBottom: '1rem', fontWeight: 400, letterSpacing: '1px', textTransform: 'uppercase' }}>C. The Zero-Fee Marketplace</h4>
            <p style={{ fontSize: '1.25rem', lineHeight: '1.8', color: '#cbd5e1', marginBottom: '1rem', fontWeight: 300 }}>The EDBIC ecosystem is powered by a proprietary, decentralized web marketplace (a "Web3 Craigslist/Fiverr").</p>
            <ul style={{ listStyle: 'none', paddingLeft: '0' }}>
              <li style={{ position: 'relative', paddingLeft: '1.5rem', marginBottom: '0.8rem', color: '#cbd5e1', lineHeight: '1.6', fontWeight: 300 }}>
                <span style={{ position: 'absolute', left: '0', color: '#ffffff' }}>•</span>
        ...
        <div style={{ background: 'rgba(255,255,255,0.02)', padding: '3rem', borderRadius: '16px', marginBottom: '3rem', border: '1px solid rgba(255,255,255,0.1)', backdropFilter: 'blur(10px)' }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(280px, 1fr))', gap: '1.5rem' }}>
            <div style={{ background: 'rgba(255, 255, 255, 0.03)', padding: '2rem', borderRadius: '12px', border: '1px solid rgba(255, 255, 255, 0.15)' }}>
              <h4 style={{ color: '#ffffff', fontSize: '1.25rem', marginBottom: '0.5rem', fontWeight: 400, letterSpacing: '1px', textTransform: 'uppercase' }}>1. The Protocol (Open-Source)</h4>
            ...
            <div style={{ background: 'rgba(255, 255, 255, 0.03)', padding: '2rem', borderRadius: '12px', border: '1px solid rgba(255, 255, 255, 0.15)' }}>
              <h4 style={{ color: '#ffffff', fontSize: '1.25rem', marginBottom: '0.5rem', fontWeight: 400, letterSpacing: '1px', textTransform: 'uppercase' }}>2. The Interface (Protected)</h4>
        ...
        <div style={{ background: 'rgba(255,255,255,0.02)', padding: '3rem', borderRadius: '16px', marginBottom: '3rem', border: '1px solid rgba(255,255,255,0.1)', backdropFilter: 'blur(10px)' }}>
          ...
          <div style={{ position: 'relative', paddingLeft: '2rem', borderLeft: '1px solid rgba(255,255,255,0.2)' }}>
            <div style={{ position: 'relative', marginBottom: '2.5rem' }}>
              ...
              <h4 style={{ fontSize: '1.4rem', color: '#ffffff', marginBottom: '0.8rem', fontWeight: 400, letterSpacing: '1px', textTransform: 'uppercase' }}>Phase 1: The Testnet MVP & Digital Freelancing</h4>
              <p style={{ fontSize: '1.25rem', lineHeight: '1.7', color: '#cbd5e1', fontWeight: 300 }}>We begin on a "Testnet"—a risk-free sandbox environment where early believers can test the UBI and demurrage mechanics using simulation tokens. The initial marketplace will focus <em style={{color: '#ffffff', fontWeight: 400, fontStyle: 'normal'}}>exclusively</em> on digital, zero-marginal-cost services. By offering graphic design, copywriting, tutoring, and software sales, we ensure that early token volatility does not harm physical retailers.</p>
            </div>
            
            <div style={{ position: 'relative', marginBottom: '2.5rem' }}>
              <div style={{ position: 'absolute', left: '-2.35rem', top: '0.3rem', width: '0.7rem', height: '0.7rem', border: '1px solid #ffffff', background: '#2a3240', borderRadius: '50%' }}></div>
              <h4 style={{ fontSize: '1.4rem', color: '#ffffff', marginBottom: '0.8rem', fontWeight: 400, letterSpacing: '1px', textTransform: 'uppercase' }}>Phase 2: Crowdfunding & The DAO Firewall</h4>
              <p style={{ fontSize: '1.25rem', lineHeight: '1.7', color: '#cbd5e1', fontWeight: 300 }}>Armed with a working MVP marketplace, we will initiate public crowdfunding matching rounds (via platforms like Gitcoin). The funds acquired will instantly trigger the legal incorporation of the EDBIC DAO, establishing a permanent, unassailable global treasury to protect the protocol.</p>
            </div>

            <div style={{ position: 'relative', marginBottom: '2.5rem' }}>
              <div style={{ position: 'absolute', left: '-2.35rem', top: '0.3rem', width: '0.7rem', height: '0.7rem', border: '1px solid #ffffff', background: '#2a3240', borderRadius: '50%' }}></div>
              <h4 style={{ fontSize: '1.4rem', color: '#ffffff', marginBottom: '0.8rem', fontWeight: 400, letterSpacing: '1px', textTransform: 'uppercase' }}>Phase 3: Mainnet Launch & Real EDBIC</h4>
              <p style={{ fontSize: '1.25rem', lineHeight: '1.7', color: '#cbd5e1', fontWeight: 300 }}>The EDBIC smart contracts deploy to a high-speed, low-cost Layer 2 network (such as World Chain or Optimism). Real value begins to flow as humans authenticate their wallets and the decentralized UBI mints its first live tokens.</p>
            </div>

            <div style={{ position: 'relative' }}>
              <div style={{ position: 'absolute', left: '-2.35rem', top: '0.3rem', width: '0.7rem', height: '0.7rem', border: '1px solid #ffffff', background: '#2a3240', borderRadius: '50%' }}></div>
              <h4 style={{ fontSize: '1.4rem', color: '#ffffff', marginBottom: '0.8rem', fontWeight: 400, letterSpacing: '1px', textTransform: 'uppercase' }}>Phase 4: Local Circular Economies</h4>
              <p style={{ fontSize: '1.25rem', lineHeight: '1.7', color: '#cbd5e1', fontWeight: 300 }}>As the velocity and value of EDBIC stabilizes through the demurrage tax, the marketplace opens up to physical, local commerce. Geo-fenced pilot cities will use the EDBIC marketplace to trade secondhand goods, fund community agriculture (CSAs), and pay for local physical labor—creating actualized, closed-loop circular economies free from fiat inflation.</p>
            </div>
          </div>
        </div>
        ...
        <div style={{ textAlign: 'center', padding: '3rem 0', background: 'rgba(255,255,255,0.02)', borderRadius: '16px', border: '1px solid rgba(255,255,255,0.1)' }}>
          <h2 style={{ fontSize: '2rem', color: '#ffffff', marginBottom: '1rem', fontWeight: 300, letterSpacing: '2px', textTransform: 'uppercase' }}>Join the EDBIC Revolution.</h2>
          <p style={{ fontSize: '1.4rem', color: '#cbd5e1', fontStyle: 'italic', fontWeight: 300, letterSpacing: '1px' }}>A currency that moves. A community that thrives.</p>
        </div>
