      ...
      {isOpen && (
        <div className="animate-fade-in">
          ...
          <div style={{ background: 'rgba(255,255,255,0.02)', padding: '4rem', borderRadius: '16px', position: 'relative', overflow: 'hidden', marginBottom: '4rem', border: '1px solid rgba(255,255,255,0.1)', backdropFilter: 'blur(10px)' }}>
            <h3 style={{ fontSize: '2.5rem', marginBottom: '2rem', color: '#ffffff', fontWeight: 300, letterSpacing: '2px' }}>UBI</h3>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: 'minmax(0, 1fr)', gap: '2rem' }}>
              <div style={{ background: 'rgba(255,255,255,0.03)', padding: '2.5rem', borderRadius: '12px', border: '1px solid rgba(255,255,255,0.1)' }}>
                <p style={{ lineHeight: '1.8', fontSize: '1.15rem', color: '#cbd5e1', fontWeight: 300 }}>
              ...
              <div style={{ background: 'rgba(255,255,255,0.05)', padding: '2.5rem', borderRadius: '12px', border: '1px solid rgba(255,255,255,0.2)' }}>
                <p style={{ lineHeight: '1.8', fontSize: '1.25rem', color: '#ffffff', fontWeight: 400 }}>
          ...
          <div style={{ background: 'rgba(255,255,255,0.02)', padding: '4rem', borderRadius: '16px', marginBottom: '4rem', border: '1px solid rgba(255,255,255,0.1)', backdropFilter: 'blur(10px)' }}>
            <h3 style={{ fontSize: '2.5rem', marginBottom: '2rem', color: '#ffffff', fontWeight: 300, letterSpacing: '2px' }}>Decentralisation Technologies</h3>
            ...
            <p style={{ fontSize: '1.15rem', marginBottom: '1.5rem', lineHeight: '1.8', color: '#cbd5e1', fontWeight: 300 }}>Whilst the primary focus still remains on the fintech sector, decentralized technologies are on the verge of affecting many more industries.</p>
            ...
            <p style={{ fontSize: '1.15rem', lineHeight: '1.8', color: '#cbd5e1', fontWeight: 300 }}>We don’t want to be viewed as uncritical ambassadors of technological advancements. The blockchain hype is no exception to this. However, we believe that grasping decentralisation is essential in order to cultivate an enlightened yet critical debate about this issue.</p>
          </div>

          {/* Social Inclusion Initiatives */}
          <div style={{ background: 'rgba(255,255,255,0.02)', padding: '4rem', borderRadius: '16px', marginBottom: '4rem', border: '1px solid rgba(255,255,255,0.1)', backdropFilter: 'blur(10px)' }}>
            <h3 style={{ fontSize: '2.5rem', marginBottom: '2rem', color: '#ffffff', fontWeight: 300, letterSpacing: '2px' }}>Social Inclusion Initiatives</h3>
            <p style={{ fontSize: '1.15rem', marginBottom: '2rem', lineHeight: '1.8', color: '#cbd5e1', fontWeight: 300 }}>Building an inclusive society is much more than a political responsibility. It involves the setting up of an inclusive culture that takes root in our society, determining the involvement and co-responsibility of each organisation and institution, each social stakeholder, and each citizen with respect to groups of people who could find themselves in a situation of vulnerability.</p>
            <p style={{ fontSize: '1.25rem', marginBottom: '1.5rem', color: '#ffffff', fontWeight: 400, letterSpacing: '0.5px' }}>We work to ensure vulnerable and marginalised people are included in society through:</p>
            <ul style={{ listStyle: 'none', padding: 0, display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(280px, 1fr))', gap: '1.5rem' }}>
              <li style={{ background: 'rgba(255,255,255,0.03)', padding: '1.5rem', borderRadius: '12px', border: '1px solid rgba(255,255,255,0.1)' }}><strong style={{ color: '#ffffff', display: 'block', marginBottom: '0.5rem', fontWeight: 400, letterSpacing: '1px' }}>Empowerment</strong> <span style={{ color: '#94a3b8', fontSize: '0.95rem', fontWeight: 300 }}>having a voice in society, access to employment, and the tools to participate in social life</span></li>
              <li style={{ background: 'rgba(255,255,255,0.03)', padding: '1.5rem', borderRadius: '12px', border: '1px solid rgba(255,255,255,0.1)' }}><strong style={{ color: '#ffffff', display: 'block', marginBottom: '0.5rem', fontWeight: 400, letterSpacing: '1px' }}>Consideration</strong> <span style={{ color: '#94a3b8', fontSize: '0.95rem', fontWeight: 300 }}>incorporating their needs in the policy making process</span></li>
              <li style={{ background: 'rgba(255,255,255,0.03)', padding: '1.5rem', borderRadius: '12px', border: '1px solid rgba(255,255,255,0.1)' }}><strong style={{ color: '#ffffff', display: 'block', marginBottom: '0.5rem', fontWeight: 400, letterSpacing: '1px' }}>Equal rights</strong> <span style={{ color: '#94a3b8', fontSize: '0.95rem', fontWeight: 300 }}>access to basic services such as housing, employment, education, health care and social services</span></li>
              <li style={{ background: 'rgba(255,255,255,0.03)', padding: '1.5rem', borderRadius: '12px', border: '1px solid rgba(255,255,255,0.1)' }}><strong style={{ color: '#ffffff', display: 'block', marginBottom: '0.5rem', fontWeight: 400, letterSpacing: '1px' }}>Community participation</strong> <span style={{ color: '#94a3b8', fontSize: '0.95rem', fontWeight: 300 }}>access to social interactions and participation to social, cultural or political activities</span></li>
            </ul>
          </div>
          ...
          <div style={{ background: 'rgba(255,255,255,0.02)', padding: '4rem', borderRadius: '16px', border: '1px solid rgba(255,255,255,0.1)', backdropFilter: 'blur(10px)' }}>
            <h3 style={{ fontSize: '2.5rem', marginBottom: '2rem', color: '#ffffff', fontWeight: 300, letterSpacing: '2px' }}>Climate Emergency</h3>
            ...
            <p style={{ fontSize: '1.3rem', color: '#ffffff', fontWeight: 400, borderLeft: '1px solid rgba(255,255,255,0.5)', paddingLeft: '1.5rem' }}>We work to bring awareness, mobilise community action and petition authorities.</p>
          </div>
        </div>
      )}
    </section>
