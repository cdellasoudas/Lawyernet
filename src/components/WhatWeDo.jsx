  ...
  return (
    <section id="what-we-do" className="container" style={{ padding: isOpen ? '6rem 2rem' : '2rem 2rem', transition: 'padding 0.3s ease' }}>
      ...
      <div className="animate-fade-in" style={{ background: 'rgba(255, 255, 255, 0.02)', padding: '4rem', borderRadius: '16px', marginBottom: '3rem', border: '1px solid rgba(255, 255, 255, 0.1)', backdropFilter: 'blur(10px)', boxShadow: '0 10px 30px rgba(0,0,0,0.3)' }}>
        <p style={{ fontSize: '1.4rem', lineHeight: '1.6', color: '#cbd5e1', textAlign: 'center', fontWeight: 300, maxWidth: '900px', margin: '0 auto 4rem' }}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(200px, 1fr))', gap: '2rem', textAlign: 'center' }}>
          <div style={{ background: 'rgba(255, 255, 255, 0.03)', padding: '2rem', borderRadius: '12px', fontSize: '1.25rem', letterSpacing: '1px', textTransform: 'uppercase', fontWeight: 400, color: '#ffffff', border: '1px solid rgba(255, 255, 255, 0.2)', transition: 'transform 0.3s' }} onMouseEnter={e => e.currentTarget.style.transform = 'translateY(-5px)'} onMouseLeave={e => e.currentTarget.style.transform = 'none'}>
            We host Meetups
          </div>
          <div style={{ background: 'rgba(255, 255, 255, 0.03)', padding: '2rem', borderRadius: '12px', fontSize: '1.25rem', letterSpacing: '1px', textTransform: 'uppercase', fontWeight: 400, color: '#ffffff', border: '1px solid rgba(255, 255, 255, 0.2)', transition: 'transform 0.3s' }} onMouseEnter={e => e.currentTarget.style.transform = 'translateY(-5px)'} onMouseLeave={e => e.currentTarget.style.transform = 'none'}>
            We speak
