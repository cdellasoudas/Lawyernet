    ...
    <section id="manifesto" className="container" style={{ padding: isOpen ? '6rem 2rem' : '2rem 2rem', transition: 'padding 0.3s ease' }}>
      <div style={{ maxWidth: '1000px', margin: '0 auto', textAlign: 'center' }}>
        ...
        <div className="animate-fade-in" style={{ background: 'rgba(255, 255, 255, 0.02)', padding: '4rem', borderRadius: '16px', border: '1px solid rgba(255, 255, 255, 0.1)', textAlign: 'left', position: 'relative', boxShadow: '0 10px 30px rgba(0,0,0,0.3)', backdropFilter: 'blur(10px)' }}>
          <p style={{ fontSize: '1.4rem', lineHeight: '1.8', color: '#cbd5e1', marginBottom: '3rem', fontWeight: 300 }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(280px, 1fr))', gap: '2rem', marginBottom: '4rem' }}>
            <div style={{ background: 'rgba(255,255,255,0.03)', padding: '2rem', borderRadius: '12px', border: '1px solid rgba(255,255,255,0.1)' }}>
              <h4 style={{ color: '#ffffff', marginBottom: '1rem', fontSize: '1.25rem', fontWeight: 400, letterSpacing: '1px', textTransform: 'uppercase' }}>Article 1 - Environment</h4>
            ...
            <div style={{ background: 'rgba(255,255,255,0.03)', padding: '2rem', borderRadius: '12px', border: '1px solid rgba(255,255,255,0.1)' }}>
              <h4 style={{ color: '#ffffff', marginBottom: '1rem', fontSize: '1.25rem', fontWeight: 400, letterSpacing: '1px', textTransform: 'uppercase' }}>Article 2 - Digital self-determination</h4>
            ...
            <div style={{ background: 'rgba(255,255,255,0.03)', padding: '2rem', borderRadius: '12px', border: '1px solid rgba(255,255,255,0.1)' }}>
              <h4 style={{ color: '#ffffff', marginBottom: '1rem', fontSize: '1.25rem', fontWeight: 400, letterSpacing: '1px', textTransform: 'uppercase' }}>Article 3 - Artificial Intelligence</h4>
            ...
            <div style={{ background: 'rgba(255,255,255,0.03)', padding: '2rem', borderRadius: '12px', border: '1px solid rgba(255,255,255,0.1)' }}>
              <h4 style={{ color: '#ffffff', marginBottom: '1rem', fontSize: '1.25rem', fontWeight: 400, letterSpacing: '1px', textTransform: 'uppercase' }}>Article 4 - Truth</h4>
            ...
            <div style={{ background: 'rgba(255,255,255,0.03)', padding: '2rem', borderRadius: '12px', border: '1px solid rgba(255,255,255,0.1)' }}>
              <h4 style={{ color: '#ffffff', marginBottom: '1rem', fontSize: '1.25rem', fontWeight: 400, letterSpacing: '1px', textTransform: 'uppercase' }}>Article 5 - Globalization</h4>
            ...
            <div style={{ background: 'rgba(255,255,255,0.03)', padding: '2rem', borderRadius: '12px', border: '1px solid rgba(255,255,255,0.1)' }}>
              <h4 style={{ color: '#ffffff', marginBottom: '1rem', fontSize: '1.25rem', fontWeight: 400, letterSpacing: '1px', textTransform: 'uppercase' }}>Article 6 - Action on fundamental rights</h4>
